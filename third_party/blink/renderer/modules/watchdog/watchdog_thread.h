...
#ifndef COBALT_WATCHDOG_THREAD_WATCHDOG_H_
#define COBALT_WATCHDOG_THREAD_WATCHDOG_H_
#include <pthread.h>
...
#include "third_party/blink/renderer/modules/watchdog/singleton.h"
#include "third_party/blink/renderer/modules/watchdog/instrumentation_log.h"
...
class WatchdogThread : public Singleton<WatchdogThread> {
 public:
//  WatchdogThread();
...
//  base::ApplicationState state_ = base::kApplicationStateStarted;
  ...
  ALLOW_DISCOURAGED_TYPE("migrating from Cobalt");
...
#endif  // COBALT_WATCHDOG_THREAD_WATCHDOG_H_